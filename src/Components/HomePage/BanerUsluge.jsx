        ...
        <>
            <section className="container-md">
                <div className="row mx-auto justify-content-between my-5">
                    <article 
                    className="banerItemContainer col-lg-3 col-6 d-flex flex-column align-items-center my-2" data-aos="aosTransformRotate360" 
                    data-aos-delay="100">
                    ...
                    data-aos="aosTransformRotate360" 
                    data-aos-delay="300">
            ...
            {/* <section className="container-md row mx-auto justify-content-between my-5">
            <article 
            className="banerItemContainer w-lg-25 w- col-lg-3 col-6 d-flex flex-column align-items-center my-2" data-aos="aosTransformRotate360"
            data-aos-delay="100">
                <GiDrill className="fs-1 mt-4 mb-3 text-danger"/>
                <h2 className="fs-4 fontW600 izoText">Obrada Stakla</h2>
                <p className="text-center text-black-50 mt-4">Precizno bušenje, brušenje, fazetiranje i još mnogo toga</p>
            ...
            <article 
            className="banerItemContainer col-lg-3 col-6 d-flex flex-column align-items-center my-2" data-aos="aosTransformRotate-360"
            data-aos-delay="300">
                <LiaPencilRulerSolid className="fs-1 mt-4 mb-3 text-danger"/>
                <h2 className="fs-4 izoText fontW600">Staklo po vašoj meri</h2>
                <p className="text-center text-black-50 mt-4">Ogledala, tuš kabine, stakleni zidovi i ograde prilagođeni vašim potrebama i prostoru..</p>
            </article>
             ...
             data-aos-delay="500">
                <BsTools className="fs-1 mt-4 mb-3 text-danger"/>
                <h2 className="fs-4 izoText fontW600">Stručna montaža</h2>
                <p className="text-center text-black-50 mt-4">Ogledala, tuš kabine, stakleni zidovi i ograde prilagođeni vašim potrebama i prostoru..</p>
            </article>
