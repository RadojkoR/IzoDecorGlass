            ...
            <section className="container-md">
                <div className="row mx-auto justify-content-between my-5">
                    <article
                        ...
                        <p className="text-center textLight mt-4">Precizno bušenje, brušenje, fazetiranje i još mnogo toga</p>
                    </article>
                    <article
                        ...
                        <p className="text-center textLight mt-4">Ogledala, tuš kabine, stakleni zidovi i ograde prilagođeni vašim potrebama i prostoru.</p>
                    </article>
                    <article
                        className="banerItemContainer col-lg-3 col-6 d-flex flex-column align-items-center my-2"
                        data-aos="flip-right"
