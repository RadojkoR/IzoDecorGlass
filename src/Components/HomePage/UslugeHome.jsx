        ...
        <section className="container-md">
                <div className="row mx-auto justify-content-center my-5">
                    ...
                    data-aos-delay="100">
                        ...
                        <p className="text-center text-black-50 mt-3">Izrađujemo staklo po meri uz precizno bušenje, brušenje i fazetiranje. Pružamo visok kvalitet i savršen završni izgled za svaki prostor.</p>
                    ...
                    data-aos-delay="300">
                        ...
                        <p className="text-center text-black-50 mt-3">Izrađujemo staklene tuš kabine po meri, spajajući funkcionalnost i moderan dizajn. Kvalitetna obrada i lako održavanje za vaš idealan prostor.</p>
                    ...
                    data-aos-delay="500">
                        ...
                        <p className="text-center text-black-50 mt-3">Izrađujemo staklene ograde koje kombinuju sigurnost i estetski dizajn. Idealno rešenje za vaš enterijer i eksterijer.</p>
                    ...
                    data-aos-delay="700">
                        ...
                        <p className="text-center text-black-50 mt-3">Nudimo ogledala po meri, savršen spoj funkcionalnosti i estetike za vaš prostor. Kvalitetna izrada i elegantan dizajn.</p>
                    ...
                    data-aos-delay="100">
                        ...
                        <p className="text-center text-black-50 mt-3">Stakleni zidovi pružaju modernu i elegantnu podelu prostora. Idealno rešenje za prozračnost i svetlost u vašem enterijeru.</p>
                    ...
                    data-aos-delay="300">
                        ...
                        <p className="text-center text-black-50 mt-3">Izrađujemo staklena vrata po meri koja spajaju eleganciju i funkcionalnost. Savršeno za moderan i svetao prostor.</p>
                    ...
                    data-aos-delay="500">
                        ...
                        <p className="text-center text-black-50 mt-3">Elegantne i funkcionalne staklene obloge za zidove koje unose modernost i lakoću održavanja u vaš prostor.</p>
